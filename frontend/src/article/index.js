...
import jsonParseSafe from '../utilities/jsonParseSafe';
...
function handleClick(e) {
    ...
    const json = versions && jsonParseSafe(versions);
...
function handleDoubleClick(e) {
    ...
    const value = (versions && u.jsonParseSafe(versions)) || text || '';
